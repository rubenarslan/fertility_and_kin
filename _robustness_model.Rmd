...
if(outcome != "person_is_related_man_seen") {
  rob_check_nonsingles = update(model, recompile = TRUE, cores = 4, newdata = diary %>% filter(reasons_for_exclusion == "", hetero_relationship == 0, relationship_status == 1), file=paste0("brms_fits/", model_prefix, "rob_check_singles"))
...
if(outcome != "person_is_related_man_seen") {
  robchecks_e[["E11. Include singles"]] = rob_check_nonsingles 
}
